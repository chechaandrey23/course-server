...
__decorate([
    (0, sequelize_typescript_1.HasOne)(() => userinfo_model_1.UserInfo),
    __metadata("design:type", userinfo_model_1.UserInfo)
], User.prototype, "userInfo", void 0);
User = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: 'users', timestamps: true, paranoid: true, deletedAt: true })
], User);
exports.User = User;
